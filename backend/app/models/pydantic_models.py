...
class PokemonAbility(BaseModel):
    ...
    # Optional linking identifier generated by the database.
    card_link_id: Optional[UUID] = None
    ability_ref: UUID
    energy_cost: dict
    ability_effect: str
...
class SupportAbility(BaseModel):
    ...
    # Optional linking identifier generated by the database.
    ability_link_id: Optional[UUID] = None
    ability_ref: UUID
...
class PokemonAbilityResponse(BaseModel):
    ...
    # The linking table now uses 'card_link_id' as the unique primary key.
    card_link_id: UUID
    ability_ref: UUID
    energy_cost: dict
    ability_effect: str
...
class SupportAbilityResponse(BaseModel):
    """Schema for Support ability responses"""
    # The linking table now uses 'ability_link_id' as the unique primary key.
    ability_link_id: UUID
    ability_ref: UUID
    support_type: Literal['Trainer', 'Item']
    effect_description: str
...
class TrainerCardResponse(CardResponse):
    ...
    abilities: List[SupportAbilityResponse]
...
class DeckResponse(BaseModel):
    ...
    updated_at: datetime
    owner_id: UUID
    cards: List[CardResponse]  # Includes full card details
